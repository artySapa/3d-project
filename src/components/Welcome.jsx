    ...
    return (
        ...
        <section className={` text-white bg-main bg-cover bg-no-repeat bg-center relative flex w-full h-screen mx-auto justify-center align-center`}>
            <div className="p-40 pl-12 text-black">
                ...
                <p className="text-5xl font-bold">Hello, my name is <span className="font-extrabold text-transparent text-5xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">Arty</span></p>
                </div>
