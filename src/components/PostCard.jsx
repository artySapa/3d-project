...
//   const userImage = userObject.picture; // save this to a database to retrieve later and thats it
  ...
  return (
    <div className="flex bg-white shadow-lg rounded-lg md:mx-auto justify-center md:max-w-xl">
      <div className="flex items-start px-4 py-6 ">
        ...
        <div className="">
          ...
          <p className="mt-3 text-gray-700 text-sm max-w-xs truncate whitespace-nowrap overflow-hidden">
            {content}
          </p>
          <div className="mt-4 flex justify-between hover:text-[#FF5733]">
            ...
            <div className="flex mr-2 text-gray-700 text-sm ml-52 hover:text-[#FF5733]">
              ...
              <button className="hover:text-[#FF5733]" onClick={() => {setDialog(true)}}>Chat</button>
            </div>
          </div>
        </div>
      </div>
